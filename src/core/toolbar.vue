		...
		<div class="box-right flex align-center pl-10">
			...
			<el-dropdown trigger="click" @command="onCommand">
				<span class="el-dropdown-link">
					...
					Сайн уу, {{user.user_name}}
				</span>
				<el-dropdown-menu slot="dropdown">
					<el-dropdown-item><i class="mdi mdi-account mr-10"></i> Хувийн мэдээлэл</el-dropdown-item>
					<el-dropdown-item  @click.native="logout" divided><i class="mdi mdi-logout mr-10"></i> Logout</el-dropdown-item>
				</el-dropdown-menu>
			</el-dropdown>
